...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/giveaway`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${SITE_URL}/giveaway/rules`, lastModified: now, changeFrequency: "monthly", priority: 0.4 },
  ];
}
